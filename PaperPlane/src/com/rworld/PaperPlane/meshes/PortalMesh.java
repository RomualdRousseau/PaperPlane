...
public class PortalMesh {
	...
	public void render(Camera2 camera) {
		v0[0] = FloatMath.floor((camera.position[0] + 2.56f) / 5.12f) * 5.12f;
		v0[1] = FloatMath.floor((camera.position[1] + 2.56f) / 5.12f) * 5.12f;
		v0[2] = FloatMath.floor((camera.position[2] + 2.56f) / 5.12f) * 5.12f;
